    ...
    <footer>
      <div className="footer-div">
        <div className="footerGridItem">
          ...
          <p className="footerP">
            Phone: <a href="tel:801-599-7447">(801)-599-7447</a>
          </p>
          <p className="footerP">Fax: (801)-303-7083</p>
          <p className="footerP">
            Email:{" "}
            <a href="mailto:russelldeewarner@gmail.com">
              RussellDeeWarner@gmail.com
            </a>
          </p>
        </div>
        <div className="footerGridItem">
          <h3 className="footerH3">License Info</h3>
          <p className="footerP">Russ Warner (NMLS #70310)</p>
          <p className="footerP">
